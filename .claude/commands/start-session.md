...
5. Report back: (a) latest handoff summary, (b) the ONE task for this session, (c) which files you'll touch, (d) any open questions for Jeremy from the docs' "Open Questions" sections that block this task.
