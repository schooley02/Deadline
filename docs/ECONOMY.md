...
Points math + this pricing formula live in `js/economy.js` (built 2026-07-18 session 19, [P1-DATA-007]): `Economy.shopPrice(baseCost, quantityOwned)`, plus `taskPoints` (high-priority ×2) and `addPoints`/`subtractPoints` (refunds floor at 0, always). The shop is BUILT ([P1-UI-008], sessions 20–24, 2026-07-18/19): repair kits + pushback live; day-tokens deferred to [P1-DATA-005].
