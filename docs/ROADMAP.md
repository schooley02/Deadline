...
- [ ] **NEW bug (found 2026-07-17 playtest):** create-habit modal doesn't close on Save — re-triggering duplicates the habit definition + sprite; shows as two entries when adding a habit to a routine. Not yet root-caused. See sessions/HANDOFF.md.
